<template>
    <div class="sorted-item-container">
        <svg v-for="n in item.num" :key="n" class="heart-img" width="16px" height="15px" viewBox="0 -1 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
